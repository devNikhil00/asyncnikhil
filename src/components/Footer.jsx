      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li><a href="/asyncnikhil/" className="hover:text-orange-300">Home</a></li>
            <li><a href="/asyncnikhil/#about" className="hover:text-orange-300">About</a></li>
            <li><a href="/asyncnikhil/#projects" className="hover:text-orange-300">Projects</a></li>
            <li><a href="/asyncnikhil/#skills" className="hover:text-orange-300">Skills</a></li>
            <li><a href="/asyncnikhil/#contact" className="hover:text-orange-300">Contact</a></li>
          </ul>
        </div>
  ...
  <div className="space-y-4 text-sm text-gray-300 mt-2 w-full text-zinc-400 border-[#1e90ff30] ">
    ...
    <details className="group  transition-all duration-200 hover:border-orange-400">
      ...
      <div className="mt-10 border-t border-[#2a2a2a] pt-6 text-center text-gray-500 text-xs px-4">
        Designed & Developed by <span className="text-orange-400 font-medium">Nikhil Prajapati</span> • © {new Date().getFullYear()} All rights reserved.
      </div>
    </footer>
  );
};
